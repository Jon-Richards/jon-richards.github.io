...
/**
 * Possible types that can be passed into the "tool" param when instantiating a
 * new Tool.
 */
...
export class Tool {
  ...
  /** If this tool recieved an unexpected value and corrected it with a valid
   * stub.
   */
  ...
  constructor(tool: ToolResponseShape) {
  ...
  /**
   * Validates a provided property against a provided array of validators.  If
   * the property is invalid, it will be replaced with an acceptable value and
   * an error will be logged to the
   * console.
   * @param prop The property to validate.
   * @param validators An array validation methods to run against the provided
   * prop param.
  ...
  /**
   * If this Tool instance recieved an unexpected value for a property and
   * orrected it with a valid stub.
   */
