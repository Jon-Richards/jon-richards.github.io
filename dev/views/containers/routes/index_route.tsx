...
const mapStateToProps = (appState: AppState): Pick<IndexProps, 
    | 'portfolio'
> => ({
    portfolio: appState.portfolio
});
...
const mapDispatchToProps = (dispatch: DispatchableActions): Pick<IndexProps,
 ...
 * route.
 */
export const INDEX_ROUTE = connect(mapStateToProps, mapDispatchToProps)(INDEX);