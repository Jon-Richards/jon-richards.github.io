...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"header":"header-iYZzH","title":"title-MXoCC","nav":"nav-YCAKM"});
...
const header = () => class Header extends lit_1.LitElement {
    ...
    <header class=${header_scss_1.default['header']}>
      ...
      <nav class=${header_scss_1.default['nav']}>
        <ol class=${header_scss_1.default['nav-list']}>
          <li class=${header_scss_1.default['nav-list__item']}>Home</li>
        </ol>
      </nav>
    </header>
  `;
